...
{
    protected string[] itemNames = new string[] { "Gold Coin", "Silver Coin", "Copper Coin", "Fireball", "Stick", "Long Sword", "Vampiric Bolt", "Boots of Swiftness" };
    ...
    protected int[,] itemStats = new int[8, 8] { {0,0,0,0,-1,0,-1,0}, {0,100,0,0,-1,0,-1,0}, {0,100,0,0,-1,0,-1,0}, {10,1,20,100,1,0,-1,0}, {0,10,0,0,-1,0,-1,0}, 
                                                {5,1,0,50,0,0,-1,0}, {5,1,25,125,1,0,-1,0}, {0,1,0,0,-1,0,2,2}};
